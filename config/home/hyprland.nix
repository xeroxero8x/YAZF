...
with lib;
{
  wayland.windowManager.hyprland = {
    ...
    extraConfig =
      ...
      bind = ${modifier},L,exec,hyprlock #Logout
      bind = ${modifier}SHIFT,L,exec,wlogout #Logout menu
      bind = ${modifier},A,exec,wofi
      bind = ${modifier},B,exec,blueman-applet
      bind = ${modifier},R,exec,rofi -show filebrowser
      bind = ${modifier},V,exec,cliphist list | wofi -dmenu | cliphist decode | wl-copy
